...
String[] messageNames = {"/output_1", "/output_2"}; //message names for each DTW gesture type
String[] messageContents = {"Normal", "Panic"}; //message names for each DTW gesture type
...
void showMessage(int i) {
    ...
    currentMessage = messageContents[i];
}
